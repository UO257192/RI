...
public class InterventionJpaRepository extends BaseJpaRepository<Intervention> implements InterventionRepository {
	...
	@Override
	public List<Intervention> findByMechanicIdBetweenDates(Long id, Date startDate, Date endDate) {

		return Jpa.getManager().createNamedQuery("Intervention.findByMechanicIdBetweenDates", Intervention.class)
