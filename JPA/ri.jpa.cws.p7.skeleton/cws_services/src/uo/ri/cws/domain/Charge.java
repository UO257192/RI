...
public class Charge extends BaseEntity {
	...
	/**
	 * Internal use. Set Invoice associated to the Charge.
	 *
	...
	/**
	 * Interal use. Set PaymentMean associated to the Charge.
	 *
	...
	public boolean equals(Object o) {
		...
		return invoice.equals(charge.invoice) && paymentMean.equals(charge.paymentMean);
	}
